...
export const staffMembers: Staff[] = [
  ...
  },
  {
    ...
    bio: "Professional and friendly with skillful, precise application. Creates beautiful results with a warm personality that makes every appointment enjoyable.",
    bioJa: "プロフェッショナルでフレンドリー、的確で精密な施術。温かい人柄で美しい結果を作り出し、すべての予約を楽しいものにします。",
    experience: "",
    experienceJa: "",
