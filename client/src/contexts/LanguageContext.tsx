...
const translations = {
  ja: {
    ...
    'access.title': 'アクセス',
    'access.subtitle': 'Richmond, BC の Aberdeen Square 3階にございます',
    'access.location': 'Location',
    'access.location.text': 'Vancouver, BC\nCanada',
    'access.location.attention': 'Aberdeen Square（アバディーン・スクエア）内の3階です。※Aberdeen Centreではありませんのでご注意ください。',
    'access.location.note': '※P4駐車場をご利用の場合、4時間無料で3階へ直結しています',
    'access.hours': '営業時間',
    'access.hours.weekday': '月〜日：10:00 - 20:00',
    'access.hours.sat': '',
    'access.hours.sun': '',
    'access.hours.closed': '定休日：なし',
  ...
  en: {
    ...
    'access.label': 'Visit Us',
    'access.title': 'Access',
    'access.subtitle': 'Located on the 3rd floor of Aberdeen Square, Richmond, BC',
    'access.location': 'Location',
    'access.location.text': 'Vancouver, BC\nCanada',
    'access.location.attention': 'Located inside Aberdeen Square on the 3rd floor. *Please note this is NOT Aberdeen Centre.',
    'access.location.note': '*Free 4-hour parking at P4, directly connected to the 3rd floor',
    'access.hours': 'Business Hours',
    'access.hours.weekday': 'Mon-Sun: 10:00 - 20:00',
    'access.hours.sat': '',
    'access.hours.sun': '',
    'access.hours.closed': 'Open 7 days a week',
    'access.contact': 'Contact',
